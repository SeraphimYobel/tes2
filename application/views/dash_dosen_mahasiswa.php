...
<script type="text/babel">
			...
			<div id="container">
				<div>
					<div className="title">
						...
						<div>
							<h1> Dosen & Mahasiswa</h1>
							<p>Pilih pada tab <strong>Mahasiswa / Dosen</strong> untuk manage data. </p>
						</div>
					</div>
					{
						showMessageSuccess ? (
	...
	const FormInputMahasiswa = props => {
			...
			$.ajax({
				...
				success: (data) => {
					...
					if(data == "true" || data > 0){
						...
						setSuccessMessage(`Mahasiswa berhasil di${type == 'add' ? 'tambahkan' : 'update'}, Terima kasih.`)
						refreshData()
		...
		return (
			<div className="forms">
				<h1>{type == 'add' ? 'Tambah' : 'Update'} Mahasiswa</h1>
